 ...
 */
extern int fmustach(const char *template_str, struct mustach_itf *itf, void *closure, FILE *file);
 ...
 * a other negative value in case of error.
 */
extern int fdmustach(const char *template_str, struct mustach_itf *itf, void *closure, int fd);
 ...
 * a other negative value in case of error.
 */
extern int mustach(const char *template_str, struct mustach_itf *itf, void *closure, char **result, size_t *size);
